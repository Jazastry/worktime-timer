...
import computer.startup.logger.ComputerStartupLogger;
import computer.startup.logger.LogType;
 ...
 */
public class StartupLoggerWindow extends JFrame implements Runnable {
...
//    minutes change 
    ...
    private void displayElapsedTime(long elapsedTime) {
         timeDisplay.setText(ComputerStartupLogger.longToDisplayString(elapsedTime));
    }
    ...
    public void startTimer() {
        startTime = ComputerStartupLogger.getStartTime();
        if (isPaused) {           
            long gapTime = pausedTime - ComputerStartupLogger.getStartTime();
             startTime =  System.currentTimeMillis() - (pausedTime - ComputerStartupLogger.getStartTime());
              isPaused = false;
              ComputerStartupLogger.writeLog(LogType.START.getName(), gapTime);
        }        
        isRunning = true;
    ...
    private void stopTimer() {
        ...
        dispose(); 
        invalidate();
        ComputerStartupLogger.writeLog(LogType.STOP.getName(), elapsed);
    }
    ...
    private void pauseTimer() {        
        if (isRunning) {
            ...
            displayElapsedTime(elapsed);
            ComputerStartupLogger.writeLog(LogType.PAUSE.getName(), elapsed);
        }        
    }
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(503, 79));
        setResizable(false);
